...
import { MOCK_BUDGETS, CATEGORIES } from '../mockData';
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
          <div className="mb-2 flex items-center gap-2 text-zinc-500">
            ...
            <span className="text-sm font-medium">Total Budget Fixed</span>
          </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
          <div className="mb-2 flex items-center gap-2 text-zinc-500">
            ...
            <span className="text-sm font-medium">Amount Spend</span>
          </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
          <div className="mb-2 flex items-center gap-2 text-zinc-500">
            ...
            <span className="text-sm font-medium">Amount Balance</span>
          </div>
          <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">${totalBalance.toLocaleString()}</p>
        </div>
      </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-zinc-500">Expense Category</label>
                  <select
                ...
                <div className="flex items-center justify-between py-2">
                  <span className="text-sm font-medium text-zinc-900 dark:text-zinc-300">Monthly Budget</span>
                  <button
                  ...
                  >
                    <div className={cn(
                      ...
                      budgetForm.isMonthly ? "left-6" : "left-1"
                    )} />
                  </button>
                </div>
